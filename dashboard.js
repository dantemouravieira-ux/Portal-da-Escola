...
function renderCredits() {
  const people = [['📊', 'Daniel', 'Desenvolvimento dos Gráficos'], ['💻', 'Dante Emanuel', 'Front End e Back End'], ['🗣️', 'Erick', 'Informantes'], ['✨', 'Ellyson', 'Experiência e Usabilidade do Usuário'], ['📣', 'Everton', 'Informante'], ['🛡️', 'Gabriel', 'Segurança do Equipamento'], ['🌡️', 'Hellen', 'Conforto Térmico'], ['☀️', 'Isabela', 'Exposição Solar'], ['🗄️', 'Kawan Eminem', 'Banco de Dados'], ['📈', 'Lorrany', 'Histórico de Dados'], ['🌿', 'Lunna Maria', 'Observação do Ambiente'], ['🎨', 'Maria Clara Alves', 'Design'], ['🔎', 'Maria Clara Souza', 'Análise de Dados'], ['💬', 'Maria Eduarda', 'Comunicação e Mensagens do WhatsApp'], ['💡', 'Monaliza', 'Decisões e Aplicações'], ['📶', 'Pedro', 'Conectividade Wi-Fi'], ['📍', 'Ronald', 'Análise de Localização'], ['🔗', 'Ruan', 'Acesso ao Sistema']];
